class Memorama{
    ...
    constructor(){
        ...
        this.availableImagesp = ['p1', 'p2', 'p3', 'p4', 'p5', 'p6'];
        this.availableImagesr = ['r1', 'r2', 'r3', 'r4', 'r5', 'r6'];
    ...
    setImagesInCards(){
        for (const key in this.cards){
            ...
            imgLabel.src = `./img/novato/${image}.png`;
    ...
    setHref(){
        ...
        document.getElementById("play-again").addEventListener("click",function() {
            window.location.href = "nivel-novato.html";}); 
