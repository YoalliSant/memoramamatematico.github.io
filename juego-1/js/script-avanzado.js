class Memorama{
    ...
    constructor(){
        ...
        this.availableImagesp = ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10'];
        this.availableImagesr = ['r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9', 'r10'];
    ...
    setImagesInCards(){
        for (const key in this.cards){
            ...
            imgLabel.src = `./img/avanzado/${image}.png`;
            ...
            imgB.src = `./img/avanzado/${strb}.png`;
    ...
    setHref(){
        ...
        document.getElementById("play-again").addEventListener("click",function() {
            window.location.href = "nivel-avanzado.html";}); 
